...
public class PropertiesMetalTheme extends DefaultMetalTheme {
    ...
    private ColorUIResource shadowColor;
    private ColorUIResource panelColor;
    private ColorUIResource songTitlePanel;
    ...
    private void initColors() {
		...
		shadowColor = super.getControlShadow();
		panelColor = super.getControlDarkShadow();
		songTitlePanel = super.getPrimaryControlDarkShadow();
    }
	...
	colorString = prop.get("shadowColor");
	if (colorString != null) {
		shadowColor = parseColor(colorString.toString()); 
	}
	
	colorString = prop.get("panelColor");
	if (colorString != null) {
		panelColor = parseColor(colorString.toString()); 
	}
	
	colorString = prop.get("songTitlePanel");
	if (colorString != null) {
		songTitlePanel = parseColor(colorString.toString()); 
	}
    ...
    public ColorUIResource getControlShadow() {return shadowColor;}
    public ColorUIResource getControlDarkShadow() {return panelColor;}
    public ColorUIResource getPrimaryControlDarkShadow() {return songTitlePanel;}
